...
capture_spec:
	...
	jmp capture_spec
set_up_target:
; Technically this is not necessary: r10 is not one of the
; registers that the ABI specifies to be saved accross call
; boundaries. However, it doesn't hurt to be safe.
	push r10
